...
export const UPGRADE_DEFS: MetaUpgrade[] = [
  ...
  { id: "vitality_3", name: "Vitality III", category: "maxHp",      cost: 60, bonus: 50, requires: "vitality_2", description: "Start each run with +50 Max HP" },
  // ── Strength (Attack) ─────────────────────────────────────────────────────
  ...
  { id: "strength_3", name: "Strength III", category: "attack",     cost: 60, bonus: 6, requires: "strength_2", description: "Start each run with +6 Attack" },
  // ── Arcane (Magic) ────────────────────────────────────────────────────────
  ...
  { id: "arcane_3",   name: "Arcane III",   category: "magic",      cost: 60, bonus: 6, requires: "arcane_2",   description: "Start each run with +6 Magic" },
  // ── Guard (Defense) ───────────────────────────────────────────────────────
  ...
  { id: "guard_3",    name: "Guard III",    category: "defense",    cost: 60, bonus: 6, requires: "guard_2",    description: "Start each run with +6 Defense" },
  // ── Special ───────────────────────────────────────────────────────────────
